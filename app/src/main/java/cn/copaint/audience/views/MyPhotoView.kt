...
object MyPhotoView{
    ...
    internal var mInterface: PhotoViewer.ShowImageViewInterface? = null
    ...
    fun setOnPhotoViewerCreatedListener(l: () -> Unit): MyPhotoView {
    ...
    fun setOnPhotoViewerDestroyListener(l: () -> Unit): MyPhotoView {
     ...
     * 设置显示ImageView的接口
     */
    fun setShowImageViewInterface(i: PhotoViewer.ShowImageViewInterface): MyPhotoView {
        mInterface = i
        PhotoViewer.setShowImageViewInterface(i)
        return this
    }
     ...
     * 设置点击一个图片
     */
    fun setClickSingleImg(data: String, view: View): MyPhotoView {
     ...
     * 设置图片数据
     */
    fun setData(data: ArrayList<String>): MyPhotoView {
        imgData = data
        return this
    }


    fun setImgContainer(container: AbsListView): MyPhotoView {
        clickView = null
        MyPhotoView.container = WeakReference(container)
        return this
    }

    fun setImgContainer(container: androidx.recyclerview.widget.RecyclerView): MyPhotoView {
        clickView = null
        MyPhotoView.container = WeakReference(container)
        return this
    }
     ...
     * 设置当前页， 从0开始
     */
    fun setCurrentPage(page: Int): MyPhotoView {
        currentPage = page
        return this
    }
    ...
    fun setOnLongClickListener(longClickListener: OnLongClickListener): MyPhotoView {
        MyPhotoView.longClickListener = longClickListener
        return this
    }
     ...
     */
    fun setIndicatorType(type: String): MyPhotoView {
        indicatorType = type
        return this
    }
